...
# ============================================
# Stock Bot Auto Click - macOS Version
# ============================================
...
print("=" * 70)
print("🍎 Stock Bot Auto Click - macOS Version")
print("=" * 70)
...
time.sleep(8)  # รอให้หน้าผลการค้นหาโหลด

# --- 4. ถ่ายภาพหน้าจอหน้าผลการค้นหา ---
print("\n📸 ถ่ายภาพหน้าจอผลการค้นหา...")
try:
    screenshot = pyautogui.screenshot()
    screenshot.save("01_search_results_macos.png")
    print("✅ บันทึก: 01_search_results_macos.png")
...
# ตำแหน่งโดยประมาณของผลการค้นหา (สำหรับ macOS)
...
for i, position in enumerate(search_result_positions[:num_results_to_visit], 1):
    ...
    try:
        ...
        screenshot_filename = f"{screenshot_counter:02d}_website_{i}_initial_macos.png"
        screenshot = pyautogui.screenshot()
        ...
        for scroll_step in range(1, num_scrolls + 1):
            ...
            screenshot_scroll = f"{screenshot_counter:02d}_website_{i}_scroll_{scroll_step}_macos.png"
            screenshot = pyautogui.screenshot()
        ...
        pyautogui.hotkey('command', 'up')  # Command + Up = Home
        time.sleep(2)
        ...
        if i < num_results_to_visit:  # ไม่ต้อง back ถ้าเป็นเว็บสุดท้าย
            ...
            pyautogui.hotkey('command', '[')  # Command + [ = Back (macOS)
            time.sleep(3)
        else:
...
for filename in os.listdir('.'):
    if filename.endswith('_macos.png') and filename.startswith(('0', '1', '2')):
...
print("   3. Command + Shift + 5 = เปิด Screenshot Tool")
