...
# ============================================
# Stock Bot Interactive - macOS Version
...
print("=" * 70)
print("🍎 Stock Bot Interactive - macOS Version")
print("=" * 70)
...
for i, position in enumerate(search_result_positions[:num_results_to_visit], 1):
    ...
    try:
        ...
        if i < num_results_to_visit:
            ...
            pyautogui.hotkey('command', '[')  # Command + [ = Back
            time.sleep(4)
        else:
...
for filename in os.listdir('.'):
    if filename.endswith('_macos.png') or (filename.endswith('.png') and filename[0].isdigit()):
